...
public class Harmony_JobDriverWait
{
	...
	internal class JobDriverWait_CheckForAutoAttack
	{
		...
		{
			if (!__instance.pawn.Downed && __instance.pawn.Faction != null && __instance.job.def == JobDefOf.Wait_Combat && (__instance.pawn.drafter == null || __instance.pawn.drafter.FireAtWill))
			{
